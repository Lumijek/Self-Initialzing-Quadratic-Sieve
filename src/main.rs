...
pub fn print_stats(
    ...
    println!("Relations per polynomial : {:.5} ", relations_per_polynomial);
...
fn main() {
    let n = "688328176060695733567653133817593886237944056362101592634801269296206820707236076007";
